...
select cus.CustomerID,cus.AccountNumber, cus.CustomerType, ind.Demographics, cus.TerritoryID,cus.ModifiedDate from customer cus 
join individual ind on ind.CustomerID = cus.CustomerID ;
