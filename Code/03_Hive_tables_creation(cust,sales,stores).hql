...
load data inpath '/input/v_customer/part-m-00000' overwrite into table customer;
load data inpath '/input/v_customer/part-m-00001' into table customer;
load data inpath '/input/v_customer/part-m-00002' into table customer;
load data inpath '/input/v_customer/part-m-00003' into table customer;
...
select CustomerID,Demographics from customer;